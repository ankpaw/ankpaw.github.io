...
const en: Translations = {
  ...
  home: {
    overline: "SOFTWARE ENGINEER",
    greeting: "Hello, my name is",
    name: "Ankit Pawar",
    tagline: "I build things for the web.",
    bio: "I'm a self-taught software developer who loves to write clean, reusable, and optimised code. Web development is my forte. I have experience in both Open Source and Microsoft stack for development of scalable, responsive web applications. Currently helping build",
    hubLink: "Hub — reinventing the financial services operating model.",
