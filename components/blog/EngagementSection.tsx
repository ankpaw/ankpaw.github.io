      ...
      <div className="flex flex-col items-center justify-center space-y-4">
        ...
        <motion.div whileTap={{ scale: 0.9 }}>
          <Button
            ...
            aria-label={
              hasLiked
                ? `Unlike post, currently ${optimisticLikedBy.size} likes`
                : `Like post, currently ${optimisticLikedBy.size} likes`
            }
            title={!isSignedIn ? "Sign in to like posts" : undefined}
          >
            <Heart
              aria-hidden="true"
