      ...
      <div className="flex flex-col items-center justify-center space-y-4">
        ...
        <motion.div whileTap={{ scale: 0.9 }}>
          <Button 
            ...
            aria-label={hasLiked ? `Unlike post, currently ${optimisticLikedBy.size} likes` : `Like post, currently ${optimisticLikedBy.size} likes`}
          ...
          >
            ...
            <span aria-hidden="true" className="text-lg font-bold">{optimisticLikedBy.size}</span>
          </Button>
        </motion.div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  {userEmail === c.email && (
                    <Button 
                      ...
                      title={deletingCommentId === c._id ? "Deleting comment..." : "Delete comment"}
